...
public interface InterbankInterface {
	 ...
	 */
	public abstract PaymentTransaction payOrder(CreditCard card, int amount, String contends)
	 ...
	 * @throw UnrecognizeException 	- neu gap mot loi khong ro nguyen nhan hoac something went wrong
	 */
	public abstract PaymentTransaction refund(CreditCard card, int amount, String contends)
			throws PaymentException, UnrecognizeException;
}
